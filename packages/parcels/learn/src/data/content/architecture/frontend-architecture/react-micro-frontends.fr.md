...
graph TD
  ...
  IM["🗺️ Import Map\n(URL versionnée par package)"]
  MFE1["📦 Parcel Home — équipe A"]
  MFE2["📦 Parcel About — équipe B"]
  Shared["⚛️ React partagé"]

  Shell --> IM
  IM -->|"déployé indépendamment"| MFE1
  IM -->|"déployé indépendamment"| MFE2
  IM --> Shared
  MFE1 --> Shared
  MFE2 --> Shared
```
