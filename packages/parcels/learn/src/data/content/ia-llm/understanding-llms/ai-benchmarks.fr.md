...
## Ce que chaque benchmark t'apporte vraiment

[MMLU](https://arxiv.org/abs/2009.03300) reste utile pour une seule chose : la connaissance générale en format QCM. Si je veux un indicateur rapide sur la couverture de connaissances académiques et professionnelles d'un modèle, je le regarde. Si je veux prédire un vrai travail multi-tour un peu sale, je l'ignore.

[HumanEval](https://arxiv.org/abs/2107.03374) est celui que je prends au sérieux pour la synthèse de code au sens étroit, parce que le pass@k mesure si des solutions échantillonnées passent des tests cachés. Ça ne dit encore presque rien sur l'édition d'une base de code vivante sous ambiguïté.
...
Je suivrais deux familles de métriques : la réussite de tâche pour ce que l'utilisateur vient vraiment chercher, et les métriques opérationnelles pour ce que ton équipe doit faire tourner. Si les deux divergent, c'est la tâche réelle qui prime.
