...
My rule of thumb is blunt: use RAG when the answer should come from documents that change, stay private, or need to be cited. Skip it when five short, stable facts already fit cleanly in the prompt.
