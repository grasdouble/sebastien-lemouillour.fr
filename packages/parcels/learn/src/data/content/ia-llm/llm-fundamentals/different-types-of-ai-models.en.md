...
My threshold is simple: if success can be measured with a clear correct answer, start with classification or regression; only jump to a generator when the job is truly open-ended.
