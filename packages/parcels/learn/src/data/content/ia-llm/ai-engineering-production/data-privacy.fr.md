...
Si vous ne pouvez pas répondre à trois questions pour un seul trajet de prompt, ne mettez pas encore ce trajet en production pour des données sensibles : qu'est-ce qui sort de votre système, combien de temps cela reste, et qui peut le récupérer ? Ensuite, lisez le guide sur la prompt injection, parce qu'un système prudent sur la confidentialité peut quand même se faire manipuler par une entrée non fiable.
