...
Si vous ne gardez qu'une règle de décision, prenez celle-ci : tout outil qui peut dépenser de l'argent, modifier des données, ou contacter quelqu'un devrait demander une vérification serveur supplémentaire ou une approbation humaine avant d'agir.
