...
If you cannot answer three questions for one prompt path, do not ship that path for sensitive data yet: what leaves your system, how long it stays, and who can retrieve it.
