...
Decision rule: if one example fixes the common case, keep it. If you still correct edge cases by hand after one clean shot, read the few-shot prompting guide next before you add more wording.
