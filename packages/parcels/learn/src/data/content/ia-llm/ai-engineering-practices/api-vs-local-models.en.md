...
If this still feels fuzzy, use a simple threshold: if you do not already have a hard offline or data-location requirement today, I would choose the API first and revisit local later.
