...
Ma règle de base est assez nette : utilisez du RAG quand la réponse doit venir de documents qui changent, restent privés ou doivent pouvoir être cités. Évitez-le quand cinq faits courts et stables tiennent déjà proprement dans le prompt. Si vous voulez la suite logique, lisez le guide sur les raisons concrètes pour lesquelles les équipes utilisent le RAG dans de vrais produits, c'est là que le choix devient vraiment pratique.
