...
feat: add AI and LLM Training catalog (4 catalogs, 101 guides — understanding-llms, building-with-llms, rag-vector-search, ai-engineering-production) with full bilingual EN/FR content.
